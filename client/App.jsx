...
const App = () => {
  ...
  const achievers = [
    { name: "Aditya Azad", event: "Advance Mountaineering Camp", dept: "CSE", year: "2025", rank: "Pro", img: "https://res.cloudinary.com/daookjsaa/image/upload/v1769339134/WhatsApp_Image_2023-08-18_at_13.01.34_gkeprd.jpg" },
    { name: "Ishita Gupta", event: "Inter-College Debate", dept: "MBA", year: "2025", rank: "Gold", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400" },
    { name: "Rahul Sharma", event: "Robo-Wars", dept: "ECE", year: "2024", rank: "Winner", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400" },
    { name: "Dev D", event: "Speed Dating", dept: "ECE", year: "2024", rank: "Winner", img: "https://res.cloudinary.com/daookjsaa/image/upload/v1769269907/samples/smile.jpg" },
  ];
