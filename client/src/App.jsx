...
const App = () => {
  ...
  const achievers = [
    ...
    { name: "Ritesh Solanki", event: "MUN", dept: "ECE", year: "2024", rank: "Winner", img: "https://res.cloudinary.com/daookjsaa/image/upload/v1769321502/download_2_ltlpls.jpg" },
  ];
      ...
      <div className="relative z-10">
        <nav className="w-full bg-[#020617]/40 backdrop-blur-2xl sticky top-0 z-[100] p-4 border-b border-white/5 flex justify-between px-6 md:px-12 items-center">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})}>
             ...
             <h1 className="text-xl font-black italic tracking-tighter">UNI-<span className="text-indigo-500 font-bold">verse Portal</span></h1>
          </div>
